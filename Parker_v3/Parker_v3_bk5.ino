...
void FrontBack(int8_t direction, int8_t times) {
  ...
  for (int cycle = 0; cycle < (times * 2); cycle++) {
    ...
    for (int a = x; a <= y; a++) {
      ...
      // SmoothFixed(smooth, cycle, x, aFixed);

      pca1.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] - degFB[0][1]) - degFB[0][0]) / vel) * SmoothFixed(smooth, cycle, x, aFixed, 1) + degFB[0][0])) * 2.694);
      ...
      // //
      // pca2.setPWM(3, 0, 115 + (180 - (((float)(degFB[3][1] - degFB[3][0]) / vel) * aFixed + degFB[3][0])) * 2.694);
      ...
      // //
      // pca1.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] + degFB[0][1])) / vel) * aFixed + (degFB[0][0] + degFB[0][1]))) * 2.694);
      ...
      pca2.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] + degFB[0][1]) - degFB[0][0]) / vel) * SmoothFixed(smooth, cycle, x, aInverted, 2) + degFB[0][0])) * 2.694);
      ...
      // //
      // pca1.setPWM(3, 0, 115 + (180 - (((float)(degFB[3][0] - degFB[3][1]) / vel) * aInverted + degFB[3][1])) * 2.694);
      ...
      // pca2.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] - degFB[0][1])) / vel) * aInverted + (degFB[0][0] - degFB[0][1]))) * 2.694);
...
float SmoothFixed(bool smooth, int cycleNow, int from, int a, int sideMotor) {
