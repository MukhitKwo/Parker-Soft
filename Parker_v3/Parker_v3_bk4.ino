...
void FrontBack(int direction, int times) {
  ...
  for (int cycle = 0; cycle < (2 * times); cycle++) {
    ...
    for (int a = x; a <= y; a++) {
      ...
      pca1.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] - degFB[0][1]) - degFB[0][0]) / vel) * aFixed + degFB[0][0])) * 2.694);
      ...
      pca2.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] + degFB[0][1]) - degFB[0][0]) / vel) * aInverted + degFB[0][0])) * 2.694);
