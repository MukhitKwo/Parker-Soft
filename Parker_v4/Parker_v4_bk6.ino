...
void FrontBack(int8_t direction, int8_t times) {
  ...
  for (int cycle = 0; cycle < times * 2; cycle++) {
    ...
    if (direction == 1) {
      ...
      y = (cycleBinary == 1) ? updates : 0;
    } else {
      //back
      x = (cycleBinary == 1) ? -updates : 0;
      y = (cycleBinary == 1) ? 0 : updates;
    }
    ...
    for (int a = x; a <= y; a++) {
      ...
      pca1.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] - degFB[0][1]) - degFB[0][0]) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[0][0])) * 2.694);
      pca1.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 1, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][0])) * 2.694);
      //
      pca2.setPWM(3, 0, 115 + (180 - (((float)(degFB[3][1] - degFB[3][0]) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[3][0])) * 2.694);
      pca2.setPWM(4, 0, 115 + (180 - MidleMov(degFB[4][1], degFB[4][0], 2, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(5, 0, 115 + (180 - (((float)(degFB[5][1] - degFB[5][0]) / (updates / 2)) * abs(SmoothFixed(aFixed, 1, x, times, cycle) - updates / 2) + degFB[5][0])) * 2.694);
      //
      pca1.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] + degFB[0][1])) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + (degFB[0][0] + degFB[0][1]))) * 2.694);
      pca1.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 3, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][1])) * 2.694);

      int aInverted = updates - aFixed;  //RLR

      pca2.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] + degFB[0][1]) - degFB[0][0]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[0][0])) * 2.694);
      pca2.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 1, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][0])) * 2.694);
      //
      pca1.setPWM(3, 0, 115 + (180 - (((float)(degFB[3][0] - degFB[3][1]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[3][1])) * 2.694);
      pca1.setPWM(4, 0, 115 + (180 - MidleMov(degFB[4][1], degFB[4][0], 2, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(5, 0, 115 + (180 - (((float)(degFB[5][1] - degFB[5][0]) / (updates / 2)) * abs(SmoothFixed(aInverted, 2, x, times, cycle) - updates / 2) + degFB[5][0])) * 2.694);
      //
      pca2.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] - degFB[0][1])) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + (degFB[0][0] - degFB[0][1]))) * 2.694);
      pca2.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 3, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][1])) * 2.694);
    }
  }
}
...
void LeftRight(int8_t direction, int8_t times) {
  ...
  for (int cycle = 0; cycle < times * 2; cycle++) {
    ...
    for (int a = x; a <= y; a++) {
      ...
      pca1.setPWM(0, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] - degFB[0][1])) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + (degFB[0][0] - degFB[0][1]))) * 2.694);
      pca1.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 1, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][0])) * 2.694);
      //
      pca2.setPWM(3, 0, 115 + (90 * 2.694));
      pca2.setPWM(4, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 3, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);                    //its finishing at 70, need 60
      pca2.setPWM(5, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][1])) * 2.694);  //its finishing at 30, need 20
      //
      pca1.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] + degFB[0][1])) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + (degFB[0][0] + degFB[0][1]))) * 2.694);
      pca1.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 3, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / updates) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][0])) * 2.694);

      int aInverted = updates - aFixed;  //RLR

      pca2.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] + degFB[0][1]) - degFB[0][0]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[0][0])) * 2.694);
      pca2.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 1, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][1])) * 2.694);
      //
      pca1.setPWM(3, 0, 115 + (90 * 2.694));
      pca1.setPWM(4, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 3, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);                    //its finishing at 70, need 60
      pca1.setPWM(5, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][0])) * 2.694);  //its finishing at 30, need 20
      //
      pca2.setPWM(6, 0, 115 + (180 - (((float)((degFB[0][0] - degFB[0][1]) - degFB[0][0]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[0][0])) * 2.694);
      pca2.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 3, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / updates) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][1])) * 2.694);
    }
  }
...
float MidleMov(int to, int from, int8_t posMotor, int8_t sideMotor, int a, int8_t nCycle, int8_t cycleTotal, int8_t times, int8_t direction) {
  ...
  if (cycleTotal == 0 || cycleTotal == (times * 2 - 1)) {  //does the same thing as SmoothFixed()
  ...
  else if (nCycle == -1) {  //elevate (triangle)
...
float SmoothFixed(int a, int sideMotor, int begin, int times, int cycleTotal) {
  ...
  if (cycleTotal == 0 || cycleTotal == (times * 2 - 1)) {  //half cycle
