...
void FrontBack(int8_t direction, int8_t times) {
  ...
  for (int cycle = 0; cycle < times * 2; cycle++) {
    ...
    for (int a = x; a <= y; a++) {
      ...
      pca1.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] - degFB[0][1]) - degFB[0][0]) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[0][0])) * 2.694);
      pca1.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 1, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][0])) * 2.694);
      //
      pca2.setPWM(3, 0, 115 + (180 - (((float)(degFB[3][1] - degFB[3][0]) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[3][0])) * 2.694);
      pca2.setPWM(4, 0, 115 + (180 - MidleMov(degFB[4][1], degFB[4][0], 2, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(5, 0, 115 + (180 - (((float)(degFB[5][1] - degFB[5][0]) / (vel / 2)) * abs(SmoothFixed(aFixed, 1, x, times, cycle) - vel / 2) + degFB[5][0])) * 2.694);
      //
      pca1.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] + degFB[0][1])) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + (degFB[0][0] + degFB[0][1]))) * 2.694);
      pca1.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 3, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][1])) * 2.694);

      int aInverted = vel - aFixed;  //RLR

      pca2.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] + degFB[0][1]) - degFB[0][0]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[0][0])) * 2.694);
      pca2.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 1, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][0])) * 2.694);
      //
      pca1.setPWM(3, 0, 115 + (180 - (((float)(degFB[3][0] - degFB[3][1]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[3][1])) * 2.694);
      pca1.setPWM(4, 0, 115 + (180 - MidleMov(degFB[4][1], degFB[4][0], 2, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(5, 0, 115 + (180 - (((float)(degFB[5][1] - degFB[5][0]) / (vel / 2)) * abs(SmoothFixed(aInverted, 2, x, times, cycle) - vel / 2) + degFB[5][0])) * 2.694);
      //
      pca2.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] - degFB[0][1])) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + (degFB[0][0] - degFB[0][1]))) * 2.694);
      pca2.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 3, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      pca2.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][1])) * 2.694);
    }
  }
}
...
void LeftRight(int8_t direction, int8_t times) {
  ...
  for (int cycle = 0; cycle < times * 2; cycle++) {
    ...
    for (int a = x; a <= y; a++) {
      ...
      pca1.setPWM(0, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] - degFB[0][1])) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + (degFB[0][0] - degFB[0][1]))) * 2.694);
      pca1.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 1, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][0])) * 2.694);
      //
      // pca2.setPWM(3, 0, 115 + (90 * 2.694));
      // pca2.setPWM(4, 0, 115 + (180 - (((float)(75 - 60) / vel) * aFixed + 60)) * 2.694);
      // pca2.setPWM(5, 0, 115 + (180 - (((float)(45 - 10) / vel) * aFixed + 10)) * 2.694);
      //
      pca1.setPWM(6, 0, 115 + (180 - (((float)(degFB[0][0] - (degFB[0][0] + degFB[0][1])) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + (degFB[0][0] + degFB[0][1]))) * 2.694);
      pca1.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][1], degFB[1][0], 3, 1, aFixed, cycleBinary, cycle, times, direction)) * 2.694);
      pca1.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][1] - degFB[2][0]) / vel) * SmoothFixed(aFixed, 1, x, times, cycle) + degFB[2][0])) * 2.694);

      int aInverted = vel - aFixed;  //RLR

      // pca2.setPWM(0, 0, 115 + (180 - (((float)((degFB[0][0] + degFB[0][1]) - degFB[0][0]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[0][0])) * 2.694);
      // pca2.setPWM(1, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 1, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      // pca2.setPWM(2, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][1])) * 2.694);
      //
      pca1.setPWM(3, 0, 115 + (90 * 2.694));
      pca1.setPWM(4, 0, 115 + (180 - (((float)(60 - 80) / vel) * aInverted + 80)) * 2.694); //Needs to finish at 60
      pca1.setPWM(5, 0, 115 + (180 - (((float)(10 - 50) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + 50)) * 2.694); //its finishing at 30
      //
      // pca2.setPWM(6, 0, 115 + (180 - (((float)((degFB[0][0] - degFB[0][1]) - degFB[0][0]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[0][0])) * 2.694);
      // pca2.setPWM(7, 0, 115 + (180 - MidleMov(degFB[1][0], degFB[1][1], 3, 2, aInverted, cycleBinary, cycle, times, direction)) * 2.694);
      // pca2.setPWM(8, 0, 115 + (180 - (((float)(degFB[2][0] - degFB[2][1]) / vel) * SmoothFixed(aInverted, 2, x, times, cycle) + degFB[2][1])) * 2.694);
    }
  }
...
float MidleMov(int to, int from, int8_t posMotor, int8_t sideMotor, int a, int8_t nCycle, int cycleNow, int times, int8_t direction) {

  if (sideMotor == 2) {
    nCycle = nCycle * -1;
  }

  if (cycleNow == 0 || cycleNow == (times * 2 - 1)) {
...
float SmoothFixed(int a, int sideMotor, int from, int times, int cycleNow) {

  if (cycleNow == 0 || cycleNow == (times * 2 - 1)) {  //half cycle
    ...
    if (from == -vel) {
      a = a - ((cycleNow == 0) ? d1 : d2);
    } else if (from == vel) {
      a = a - ((cycleNow == 0) ? d2 : d1);
    }
