...
void Step(String st) {
  ...
  if (st == "RLRb") {
    // RLR to back
    for (int a = 0; a <= 360; a++) {
      pca1.setPWM(0, 0, 115 + (180 - (-0.138888 * a + 90)) * 2.694);
      pca1.setPWM(1, 0, 115 + (180 - (-0.055555 * a + 80)) * 2.694);
      pca1.setPWM(2, 0, 115 + (180 - (-0.111111 * a + 50)) * 2.694);
      //
      pca2.setPWM(3, 0, 115 + (180 - (0.138888 * a + 65)) * 2.694);
      pca2.setPWM(4, 0, 115 + (180 - (0.055555 * abs(a - 180) + 60)) * 2.694);
      pca2.setPWM(5, 0, 115 + (180 - (0.055555 * abs(a - 180) + 20)) * 2.694);
      //
      pca1.setPWM(6, 0, 115 + (180 - (-0.138888 * a + 140)) * 2.694);
      pca1.setPWM(7, 0, 115 + (180 - (0.055555 * a + 60)) * 2.694);
      pca1.setPWM(8, 0, 115 + (180 - (0.111111 * a + 10)) * 2.694);
    }
  } else if (st == "RLRf") {
    // RLR to front
    for (int a = 360; a >= 0; a--) {
      pca1.setPWM(0, 0, 115 + (180 - (-0.138888 * a + 90)) * 2.694);
      pca1.setPWM(1, 0, 115 + (180 - (-0.055555 * (a + 360) + 80)) * 2.694);
      pca1.setPWM(2, 0, 115 + (180 - (-0.111111 * a + 50)) * 2.694);
      //
      pca2.setPWM(3, 0, 115 + (180 - (0.138888 * a + 65)) * 2.694);
      pca2.setPWM(4, 0, 115 + (180 - (0.055555 * abs(a - 180) + 40)) * 2.694);
      pca2.setPWM(5, 0, 115 + (180 - (0.055555 * abs(a - 180) + 20)) * 2.694);
      //
      pca1.setPWM(6, 0, 115 + (180 - (-0.138888 * a + 140)) * 2.694);
      pca1.setPWM(7, 0, 115 + (180 - (0.055555 * (a - 360) + 60)) * 2.694);
      pca1.setPWM(8, 0, 115 + (180 - (0.111111 * a + 10)) * 2.694);
    }
  } else if (st == "LRLb") {
    // LRL to back
    for (int a = 0; a <= 360; a++) {
      pca2.setPWM(0, 0, 115 + (180 - (0.138888 * a + 90)) * 2.694);
      pca2.setPWM(1, 0, 115 + (180 - (-0.055555 * a + 80)) * 2.694);
      pca2.setPWM(2, 0, 115 + (180 - (-0.111111 * a + 50)) * 2.694);
      //
      pca1.setPWM(3, 0, 115 + (180 - (-0.138888 * a + 115)) * 2.694);
      pca1.setPWM(4, 0, 115 + (180 - (0.055555 * abs(a - 180) + 60)) * 2.694);
      pca1.setPWM(5, 0, 115 + (180 - (0.055555 * abs(a - 180) + 20)) * 2.694);
      //
      pca2.setPWM(6, 0, 115 + (180 - (0.138888 * a + 40)) * 2.694);
      pca2.setPWM(7, 0, 115 + (180 - (0.055555 * a + 60)) * 2.694);
      pca2.setPWM(8, 0, 115 + (180 - (0.111111 * a + 10)) * 2.694);
    }
  } else if (st == "LRLf") {
    // LRL to front
    for (int a = 360; a >= 0; a--) {
      pca2.setPWM(0, 0, 115 + (180 - (0.138888 * a + 90)) * 2.694);
      pca2.setPWM(1, 0, 115 + (180 - (-0.055555 * (a + 360) + 80)) * 2.694);
      pca2.setPWM(2, 0, 115 + (180 - (-0.111111 * a + 50)) * 2.694);
      //
      pca1.setPWM(3, 0, 115 + (180 - (-0.138888 * a + 115)) * 2.694);
      pca1.setPWM(4, 0, 115 + (180 - (0.055555 * abs(a - 180) + 40)) * 2.694);
      pca1.setPWM(5, 0, 115 + (180 - (0.055555 * abs(a - 180) + 20)) * 2.694);
      //
      pca2.setPWM(6, 0, 115 + (180 - (0.138888 * a + 40)) * 2.694);
      pca2.setPWM(7, 0, 115 + (180 - (0.055555 * (a - 360) + 60)) * 2.694);
      pca2.setPWM(8, 0, 115 + (180 - (0.111111 * a + 10)) * 2.694);
    }
  }
  ...
  if (st == "RLRu") {
    ...
    pca1.setPWM(1, 0, 115 + (180 - (-0.055555 * (360 + 360) + 80)) * 2.694);
    pca2.setPWM(4, 0, 115 + (180 - (0.055555 * abs(360 - 180) + 40)) * 2.694);
    pca1.setPWM(7, 0, 115 + (180 - (0.055555 * (360 - 360) + 60)) * 2.694);
    delay(200);
  } else if (st == "RLRd") {
    //RLR legs move down at front
    pca1.setPWM(1, 0, 115 + (180 - (-0.055555 * (0) + 80)) * 2.694);
    pca2.setPWM(4, 0, 115 + (180 - (0.055555 * abs(0 - 180) + 60)) * 2.694);
    pca1.setPWM(7, 0, 115 + (180 - (0.055555 * (0) + 60)) * 2.694);
    delay(200);
  } else if (st == "LRLu") {
    //LRL legs move up at back
    pca2.setPWM(1, 0, 115 + (180 - (-0.055555 * (360 + 360) + 80)) * 2.694);
    pca1.setPWM(4, 0, 115 + (180 - (0.055555 * abs(360 - 180) + 40)) * 2.694);
    pca2.setPWM(7, 0, 115 + (180 - (0.055555 * (360 - 360) + 60)) * 2.694);
    delay(200);
  } else if (st == "LRLd") {
    //LRL legs move down at front
    pca2.setPWM(1, 0, 115 + (180 - (-0.055555 * (0) + 80)) * 2.694);
    pca1.setPWM(4, 0, 115 + (180 - (0.055555 * abs(0 - 180) + 60)) * 2.694);
    pca2.setPWM(7, 0, 115 + (180 - (0.055555 * (0) + 60)) * 2.694);
    delay(200);
  }
}
